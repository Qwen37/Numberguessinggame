package com.qwen.numberguessinggame
    ...
    when {
        ...
        guessNumberString.toIntOrNull() != null -> {
            ...
            if (guessNumberInt == randomNumber && count < 5) {
                ...
                Toast.makeText(this, "You guessed correctly", Toast.LENGTH_SHORT)
            } else if (count >= 5){
                Toast.makeText(this, "You have reached the maximum number of guesses", Toast.LENGTH_SHORT)
            } else {
